module TensorStream
  ...
  class NN
    ...
    class << self
      ...
      def conv2d(input, filter, strides, padding, data_format: 'NHWC', dilations: [1, 1, 1, 1], name: nil)
        _op(:conv2d, input, filter, strides, padding, data_format: data_format, dilations: dilations, name: name)
      end
    end
  end
